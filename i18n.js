(function initBeautyLabI18n(global) {
  ...
  const english = {
    ...
    "预览与编辑器隔离，网络资源被阻止": "Preview is isolated from the editor and network access is blocked",
    ...
    "编辑画布和安全预览会阻止网络访问。请把图片、字体和脚本改为内嵌资源，确保断网演示正常。": "The editing canvas and safe preview block network access. Embed images, fonts, and scripts for reliable offline presenting.",
  ...
  const patterns = [
    ...
    [/^编辑时已禁用 (\d+) 项脚本行为$/, (_, count) => `Disabled ${count} scripted behaviors while editing`],
